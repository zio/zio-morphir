...
trait MorphirJsonCodecV1 {
  ...
  implicit def valueEncoder[Annotations](implicit annotationsEncoder:JsonEncoder[Annotations]):JsonEncoder[Value[Annotations]] = ???
  implicit def typeEncoder[Annotations](implicit annotationsEncoder:JsonEncoder[Annotations]):JsonEncoder[Type[Annotations]] = ???

  def encodePackageDefinition[Annotations](packageDefinition:PackageDefinition[Annotations])(implicit annotationEncoder:JsonEncoder[Annotations]):CharSequence = {
  ...
  def encodeModuleDefinition[Annotations](moduleDef:ModuleDefinition[Annotations])(implicit annotationEncoder:JsonEncoder[Annotations]):CharSequence = ???
